...
# def main():
#     """
#     Main function to load raw data, preprocess it, and save to interim folder.
#     """
#     try:
#         # Configuration parameters (Hardcoded, no YAML)
#         text_column = 'text'
...
#         logger.debug('Data loaded properly from %s and %s', input_train_path, input_test_path)
